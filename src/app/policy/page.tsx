    ...
    <div>
        <div className="m-6">
          ...
          <p>
            ...
            предпринимаемые Герметдом (далее&nbsp;— Оператор)..
            <br />
          ...
          consindustry16@gmail.com с пометкой «Актуализация персональных
          данных».
          <br />
          ...
          на электронный адрес Оператора consindustry16@gmail.com с пометкой
          ...
          Оператору с помощью электронной почты consindustry16@gmail.com.
          <br />
          ...
          сети Интернет по адресу https://alfaplast136.ru/privacy.<p></p>
        </div>
    </div>
  );
};
